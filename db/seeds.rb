User.create!([
  {email: "customer@bibo.com", encrypted_password: "$2a$11$TpJ8AQVyrifelTrPdGwLx.AmW63NyYnhLwpzeHttMzIGHg1sqDrMC", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 2, current_sign_in_at: "2017-04-22 06:03:22", last_sign_in_at: "2017-04-22 05:57:28", current_sign_in_ip: "127.0.0.1", last_sign_in_ip: "127.0.0.1", name: "customer", location: "BGC", account_type: "customer"},
  {email: "owner@bibo.com", encrypted_password: "$2a$11$Ndpyou8ZsAYRYDTNrgfaRupgoGEDvMWvBn25phHtaCUOf6e8xjUAW", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 2, current_sign_in_at: "2017-04-22 06:04:12", last_sign_in_at: "2017-04-22 05:58:00", current_sign_in_ip: "127.0.0.1", last_sign_in_ip: "127.0.0.1", name: "owner", location: "BGC", account_type: "owner"}
])
Menu.create!([
